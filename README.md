...
**特点**：
- 5 种稿件类型全覆盖（集团拜会省领导 / 集团会见伙伴 / 公司拜会市县 / 公司会见伙伴 / 内部研讨部署 ⭐新增）
- 内置完整高层次词汇库、格式规范和 5 套填空模板
- ⭐ 自动搜索互联网最新数据补充稿件说服力（装机量、政策目标等）
- ⭐ 国资央企文风铁律（7 大类对照表，过审保障）
- 所有模板均已脱敏，可直接部署到公开仓库

**文件结构**：
```
CCTV-NEWS/
├── SKILL.md              # 完整工作流程 + 数据补充规则 + 国资央企文风铁律
└── references/
    └── template.md        # V2.1 表达范式模板（5型+词库+填空模板+E型范例）
```
